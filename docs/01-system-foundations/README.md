...
All entities use stable IDs such as `SectionId`, `LyricPhraseId`, `ProsodicPatternId`, `ProsodicUnitId`, `SyllablePlacementId`, `RhythmCandidateId`, `RhythmCandidateEventId`, `TrackId`, `ClipId`, `NoteId`, and `InstrumentId`. Cross-domain relationships reference IDs rather than copying data.
