...
The current implementation can derive inspectable low-end support and pulse ideas from approved notes, accept each as one reversible musical part, audition existing harmony, and export approved notes as MIDI. It does not yet generate a complete arrangement.
