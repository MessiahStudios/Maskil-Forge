...
[JsonConverter(typeof(PerformanceObservationIdJsonConverter))]
public readonly record struct PerformanceObservationId(Guid Value)
{
    public static PerformanceObservationId New() => new(Guid.NewGuid());
    public override string ToString() => Value.ToString();
}

[JsonConverter(typeof(PerformanceObservationReviewIdJsonConverter))]
public readonly record struct PerformanceObservationReviewId(Guid Value)
{
    public static PerformanceObservationReviewId New() => new(Guid.NewGuid());
    public override string ToString() => Value.ToString();
}

[JsonConverter(typeof(PerformanceObservationCorrectionIdJsonConverter))]
public readonly record struct PerformanceObservationCorrectionId(Guid Value)
{
    public static PerformanceObservationCorrectionId New() => new(Guid.NewGuid());
    public override string ToString() => Value.ToString();
}

[JsonConverter(typeof(PerformanceObservationGestureIdJsonConverter))]
public readonly record struct PerformanceObservationGestureId(Guid Value)
{
    public static PerformanceObservationGestureId New() => new(Guid.NewGuid());
    public override string ToString() => Value.ToString();
}

[JsonConverter(typeof(VocalTakePlacementIdJsonConverter))]
public readonly record struct VocalTakePlacementId(Guid Value)
{
    public static VocalTakePlacementId New() => new(Guid.NewGuid());
    public override string ToString() => Value.ToString();
}
...
[JsonConverter(typeof(SectionRoleAssignmentIdJsonConverter))]
public readonly record struct SectionRoleAssignmentId(Guid Value)
{
    public static SectionRoleAssignmentId New() => new(Guid.NewGuid());
    public override string ToString() => Value.ToString();
}

[JsonConverter(typeof(MusicalPartIdJsonConverter))]
public readonly record struct MusicalPartId(Guid Value)
{
    public static MusicalPartId New() => new(Guid.NewGuid());
    public override string ToString() => Value.ToString();
}
...
{
    public static SchemaVersion Current => new(30);
}
...
internal sealed class PerformanceObservationIdJsonConverter : GuidIdJsonConverter<PerformanceObservationId>
{
    protected override PerformanceObservationId Create(Guid value) => new(value);
    protected override Guid GetValue(PerformanceObservationId value) => value.Value;
}

internal sealed class PerformanceObservationReviewIdJsonConverter : GuidIdJsonConverter<PerformanceObservationReviewId>
{
    protected override PerformanceObservationReviewId Create(Guid value) => new(value);
    protected override Guid GetValue(PerformanceObservationReviewId value) => value.Value;
}

internal sealed class PerformanceObservationCorrectionIdJsonConverter : GuidIdJsonConverter<PerformanceObservationCorrectionId>
{
    protected override PerformanceObservationCorrectionId Create(Guid value) => new(value);
    protected override Guid GetValue(PerformanceObservationCorrectionId value) => value.Value;
}

internal sealed class PerformanceObservationGestureIdJsonConverter : GuidIdJsonConverter<PerformanceObservationGestureId>
{
    protected override PerformanceObservationGestureId Create(Guid value) => new(value);
    protected override Guid GetValue(PerformanceObservationGestureId value) => value.Value;
}

internal sealed class VocalTakePlacementIdJsonConverter : GuidIdJsonConverter<VocalTakePlacementId>
{
...
internal sealed class SectionRoleAssignmentIdJsonConverter : GuidIdJsonConverter<SectionRoleAssignmentId>
{
    protected override SectionRoleAssignmentId Create(Guid value) => new(value);
    protected override Guid GetValue(SectionRoleAssignmentId value) => value.Value;
}

internal sealed class MusicalPartIdJsonConverter : GuidIdJsonConverter<MusicalPartId>
{
    protected override MusicalPartId Create(Guid value) => new(value);
    protected override Guid GetValue(MusicalPartId value) => value.Value;
}
