...
internal sealed class V26ToV27ProjectMigration : IProjectMigration
{
    public int FromVersion => 26;
    public int ToVersion => 27;

    public JsonObject Apply(JsonObject project)
    {
        project["performanceObservationGestures"] = new JsonArray();
        project["schemaVersion"] = ToVersion;
        return project;
    }
}

internal sealed class V27ToV28ProjectMigration : IProjectMigration
{
    public int FromVersion => 27;
    public int ToVersion => 28;

    public JsonObject Apply(JsonObject project)
    {
        project["vocalTakePlacements"] = new JsonArray();
        project["schemaVersion"] = ToVersion;
        return project;
    }
}

internal sealed class V28ToV29ProjectMigration : IProjectMigration
{
    public int FromVersion => 28;
    public int ToVersion => 29;

    public JsonObject Apply(JsonObject project)
    {
        project["expressionCurves"] = new JsonArray();
        project["schemaVersion"] = ToVersion;
        return project;
    }
}

internal sealed class V29ToV30ProjectMigration : IProjectMigration
{
    public int FromVersion => 29;
    public int ToVersion => 30;

    public JsonObject Apply(JsonObject project)
    {
        if (project["musicalParts"] is JsonArray musicalParts)
        {
...
internal sealed class V31ToV32ProjectMigration : IProjectMigration
{
    public int FromVersion => 31;
    public int ToVersion => 32;
...
internal sealed class V33ToV34ProjectMigration : IProjectMigration
{
    public int FromVersion => 33;
    public int ToVersion => 34;
    public JsonObject Apply(JsonObject project)
    {
...
internal sealed class V35ToV36ProjectMigration : IProjectMigration
{
    public int FromVersion => 35;
    public int ToVersion => 36;
    public JsonObject Apply(JsonObject project)
    {
