...
export type InstrumentArticulation = 'Legato' | 'BowExpression' | 'Slide' | 'Picking' | 'Bend' | 'HammerOn' | 'Strike' | 'Pedal' | 'Finger' | 'Slap' | 'Hit' | 'Choke' | 'Breath' | 'Tonguing' | 'Pad' | 'Filter' | 'Portamento' | 'Distortion' | 'PalmMute'
...
export interface InstrumentMidiControllerAssignment {
  instrumentId: string
  instrumentName: string
  applicable: boolean
  articulation: InstrumentArticulation | null
...
export interface InstrumentMidiControllerMapSet {
  assignments: InstrumentMidiControllerAssignment[]
}

export interface InstrumentMidiPitchBendAssignment {
  instrumentId: string
  instrumentName: string
  applicable: boolean
  articulation: InstrumentArticulation | null
...
export interface InstrumentMidiPitchBendMapSet {
...
export interface PerformanceObservationGesture {
  id: string
  observationId: string
  measurements: PerformanceMeasurement[]
  createdUtc: string
...
export interface PitchFrameReport {
  startMilliseconds: number
  durationMilliseconds: number
...
export const projectsApi = {
  ...
  promotePerformanceObservation: (
    id: string,
    observationId: string,
    baseProjectLastModifiedUtc: string,
    promoted: true | null,
  ) => request<ProjectResponse>(
    `/api/projects/${encodeURIComponent(id)}/performance-observations/${encodeURIComponent(observationId)}/gesture`,
    { method: 'PUT', body: JSON.stringify({ baseProjectLastModifiedUtc, promoted }) },
  ),
